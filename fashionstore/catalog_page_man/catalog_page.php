  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        ...
        <h1 class="my-4">Męskie</h1>
        <div class="list-group">
          <a href="#" class="list-group-item">Kurtki</a>
          <a href="#" class="list-group-item">Bluzy</a>
      ...
      <div class="col-lg-9">
        ...
        $sql = 'SELECT * FROM product where id_sex = 1';
...
<footer class="py-3 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; Dawid Halada</p>
    </div>
