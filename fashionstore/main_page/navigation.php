    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="../catalog_page_man/catalog_page.php">Męskie
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="../catalog_page_woman/catalog_page.php">Damskie</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
              ...
              if(isset($_SESSION["USERNAME"]))
              {
                  ...
                  elseif ($_SESSION["USERNAME"]=="Sprzedawca"){
                      echo '<a class="nav-link" href="../proccesing/seller_panel.php">Sprzedawca</a>';
                  }
                  else{
